...
Do the same for phase2task2 and phase2task3. Just run the cells in order from top to bottom and everything works on its own. Task 2 pulls its data straight from GitHub, Task 1 pulls its data from the datasets library, and Task 3 creates its own sample data inside the notebook.
